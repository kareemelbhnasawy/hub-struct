...
export const themeColors = {
  ...
  textBrandOrange: {
    ...
    dark: COLORS['secondary-orange-500'],
  },
  textBrandGreen: {
  ...
  borderBrandPrimaryLight: {
    light: COLORS['primary-200'],
    dark: COLORS['primary-800'],
  },
  borderBrandPrimaryLightAlt: {
  ...
  borderBrandOrangeLight: {
    light: COLORS['secondary-orange-200'],
    dark: COLORS['secondary-orange-800'],
  },
  ...
  borderBrandGreenLight: {
    light: COLORS['secondary-green-200'],
    dark: COLORS['secondary-green-800'],
  },
  ...
  iconPrimaryLight: {
    light: COLORS['secondary-yellow-25'],
    dark: COLORS['secondary-yellow-25'],
  },
  iconPrimary400: {
  ...
  iconSecondaryLight: {
    ...
    dark: COLORS['secondary-green-25'],
  },
  iconTertiaryLight: {
    light: COLORS['primary-25'],
    dark: COLORS['primary-25'],
  ...
  borderSecondaryGreen: {
    light: COLORS['secondary-green-600'],
    dark: COLORS['secondary-green-300'],
  },
  borderSecondaryTeal: {
    light: COLORS['secondary-teal-600'],
    dark: COLORS['secondary-teal-300'],
  },
  borderPrimary600: {
    light: COLORS['primary-600'],
    dark: COLORS.white,
  ...
  stepperButtonUpcomming: {
    light: COLORS['neutral-300'],
    dark: COLORS['neutral-600'],
  },
  stepperButtonUpcommingHovered: {
    light: COLORS['neutral-400'],
    dark: COLORS['neutral-600'],
  },
